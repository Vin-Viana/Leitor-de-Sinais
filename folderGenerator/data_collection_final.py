...
count = len(oss.listdir("C:\\Users\\vicos\\Documents\\.PY\\dataSet\\Ç"))
c_dir = 'Ç'
...
cv2.imwrite("./white-background.jpg",white)
    ...
    try:
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='Ç'
            flag = False
            count = len(oss.listdir("C:\\Users\\vicos\\Documents\\.PY\\dataSet" + (c_dir) + "\\"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite("C:\\Users\\vicos\\Documents\\.PY\\dataSet" + (c_dir) + "\\" + str(count) + ".jpg",
                            skeleton1)
